...
namespace Valadate {
	...
	public delegate void CancelableAsyncBegin(Cancellable cancel,
	 ...
	 */
	public bool wait_for_condition(int timeout,
			Object emitter, string signame,
	 ...
	 */
	public bool wait_for_signal(int timeout,
			Object emitter, string signame, Block block) {
	...
	public bool wait_for_cancellable_async(int timeout,
			CancelableAsyncBegin async_function,
			AsyncFinish async_finish) {
		var loop = new MainLoop(MainContext.default(), true);
		AsyncResult? result = null;
